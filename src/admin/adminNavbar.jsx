...
const AdminNavbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-64 h-screen bg-black/70 text-white flex flex-col overflow-y-auto">
      {/* Logo */}
      <div className="p-6 border-b border-white/50">
        <div className="flex items-center justify-center">
          <h1 className="ml-2 font-serif text-2xl font-medium text-white">VoyageVue</h1>
        </div>
      </div>
      ...
      <nav className="px-4 py-6 space-y-1 flex-1">
        {navItems.map((item) => (
          <div
            key={item.path}
            className="flex items-center px-4 py-3 rounded-lg cursor-pointer transition-colors duration-200 hover:bg-blue-800"
      ...
      <div className="p-6 w-full">
        <button
          ...
          className="flex items-center w-full px-4 py-3 rounded-lg text-gray-300 hover:bg-blue-800 hover:text-white transition-colors duration-200"
        >
